...
/*   Updated: 2024/11/06 17:06:05 by njeanbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../c3d_inc/cub3d.h"

void	extract_south(t_data **data, char **buf)
{
...
void	extract_east(t_data **data, char **buf)
{
...
void	extract_west(t_data **data, char **buf)
{
...
void	extract_door(t_data **data, char **buf)
{
...
void	extract_texture(t_data **data, char **buf)
{
	...
	extract_south(data, buf);
	extract_east(data, buf);
	extract_west(data, buf);
	extract_door(data, buf);
