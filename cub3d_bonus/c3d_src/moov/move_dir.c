...
/*   Updated: 2024/11/19 16:10:24 by njeanbou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_right(t_data **data)
{
	if ((*data)->m_right == true)
	{
		if ((*data)->map[(int)((*data)->player_y - (*data)->dir_x * 0.4)]
			[(int)(*data)->player_x] != '1'
			&& (*data)->map[(int)((*data)->player_y - (*data)->dir_x * 0.4)]
				[(int)(*data)->player_x] != 'D')
			(*data)->player_y -= (*data)->dir_x * 0.1;
		if ((*data)->map[(int)(*data)->player_y]
			[(int)((*data)->player_x - -(*data)->dir_y * 0.4)] != '1'
			&& (*data)->map[(int)(*data)->player_y]
				[(int)((*data)->player_x - -(*data)->dir_y * 0.4)] != 'D')
